...
public class ArchitectViewExtensionActivity extends ArActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        extensions.put(EXTENSION_APPLICATION_MODEL_POIS, new PoiDataFromApplicationModel(this, architectView));
       ...
       /* Intent intent = getIntent();
        ...
        for (String extension : sampleData.getExtensions()) {
            Log.d("Value of SampleData",extension);
            switch (extension) {
        ...
        if (extensions.containsKey(EXTENSION_GEO) && extensions.containsKey(EXTENSION_APPLICATION_MODEL_POIS)) {
            PoiDataFromApplicationModel applicationModelExtension = (PoiDataFromApplicationModel) extensions.get(EXTENSION_APPLICATION_MODEL_POIS);
